...
func (q groupsUserQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GroupsUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for groups_users")
	}
...
func (q groupsUserQuery) All(ctx context.Context, exec boil.ContextExecutor) (GroupsUserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to GroupsUser slice")
	}
...
func (q groupsUserQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count groups_users rows")
	}
...
func (q groupsUserQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if groups_users exists")
	}
...
func FindGroupsUser(ctx context.Context, exec boil.ContextExecutor, groupID int64, userID int64, selectCols ...string) (*GroupsUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from groups_users")
	}
...
func (o *GroupsUser) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no groups_users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into groups_users")
	}
...
func (o *GroupsUser) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update groups_users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update groups_users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for groups_users")
	}
...
func (q groupsUserQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for groups_users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for groups_users")
	}
...
func (o GroupsUserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in groupsUser slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all groupsUser")
	}
	return rowsAff, nil
}
...
func (o *GroupsUser) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no groups_users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert groups_users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert groups_users")
	}
...
func (o *GroupsUser) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no GroupsUser provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from groups_users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for groups_users")
	}
...
func (q groupsUserQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no groupsUserQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from groups_users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for groups_users")
	}
...
func (o GroupsUserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from groupsUser slice")
	}
...
func (o *GroupsUser) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no GroupsUser provided for reload")
	}
...
func (o *GroupsUserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty GroupsUserSlice provided for reload all")
	}
...
func (o *GroupsUserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in GroupsUserSlice")
	}
...
func GroupsUserExists(ctx context.Context, exec boil.ContextExecutor, groupID int64, userID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if groups_users exists")
	}
